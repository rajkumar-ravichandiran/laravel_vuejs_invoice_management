            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="row mb-3 login_btn">
                            <div class="col-md-12 text-center mb-2">
                                <button type="button" onclick="loginAs('admin@invoice.app')" class="btn btn-outline-danger btn-sm">Login as Admin</button>
                            </div>                            
                        </div>
                         <form id="loginform" role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input id="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Password') }}" type="password" value="" required>
                                </div>
